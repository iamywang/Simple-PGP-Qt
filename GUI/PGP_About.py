...
class PGP_About(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "PyQt5-PGPClient Version 1.1.20181205"))
        self.label_2.setText(
            _translate("Dialog", "PGP（英语：Pretty Good Privacy，中文翻译“优良保密协议”）是一套用于消息加密、验证的应用程序，采用IDEA的散列算法作为加密与验证之用。"))
